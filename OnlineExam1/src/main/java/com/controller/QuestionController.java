...
import com.TCS.entity.Answer;
import com.TCS.entity.Questions;
import com.TCS.entity.Score;
...
public class QuestionController {
	...
	// qno=1 question=what is java? submittedAnswer="language" . This is coming from
	// browser
	// Answer class object will be created by Spring using default constructor
	// Answer answer=new Answer();
	// [qno=0 question=null submittedAnswer=null correctAnswer=null] Answer class
	// object
	// answer.setQno(1);
	// [qno=1 question=what is java? submittedAnswer="language" correctAnswer=null]
	// Answer class object
	...
	public void storeResponse(Answer answer, HttpServletRequest request) {
		...
		HashMap<Integer, Answer> hashmapobject = (HashMap<Integer, Answer>) httpSession
				.getAttribute("submittedDetails");
...
//		{
	...
	public ModelAndView endexam(HttpServletRequest request) {
		 ...
		 * java.lang.NullPointerException: Cannot invoke "java.util.HashMap.values()"
		 * because "hashmapobject" is null at
		 * com.javabykiran.controller.QuestionController.endexam(QuestionController.java
		 * :207)
		 */
